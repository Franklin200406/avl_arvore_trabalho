...
class ArvoreAVL {
    ...
    // Leitura do CSV e testes de desempenho
    public static void main(String[] args) throws IOException {
        ...
        try (PrintWriter log = new PrintWriter("desempenho_log.txt")) {
            log.println("Desempenho AVL vs TreeMap");
        ...
        System.out.println("Testes de desempenho registrados em desempenho_log.txt");
    }
} 
